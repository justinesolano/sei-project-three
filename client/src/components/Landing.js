...
import smileyProfile from '../assets/smileyfaceblue.jpg'
        ...
        <Link to="/login">
          <Reveal animated='fade' className="column">
            ...
            <Reveal.Content hidden>
              <Image src={smileyProfile} size='small' />
            </Reveal.Content>
          </Reveal>
        </Link>
        <Link to="/register">
